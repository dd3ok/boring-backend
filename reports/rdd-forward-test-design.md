# RDD Design Forward Test: Reservation API

## Skill And References Used

- Skill: `C:\Users\hwick\Documents\dev\agent-lab\skills\rdd-design\SKILL.md`
- References:
  - `skills/rdd-design/references/guard-catalog.md`
  - `skills/rdd-design/references/security-guard-catalog.md`
  - `skills/rdd-design/references/performance-guard-catalog.md`
  - `skills/rdd-design/references/resilience-guard-catalog.md`
  - `skills/rdd-design/references/forward-test-prompts.md`

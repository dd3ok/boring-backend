...
Read this file only when the task touches auth, roles, ownership, sensitive business flows, public input, field binding, secrets, logs, CORS/TLS, user-controlled URLs, or third-party API responses.

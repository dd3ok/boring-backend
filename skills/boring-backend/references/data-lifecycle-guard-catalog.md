...
| Grade | Meaning |
|---|---|
| P1 | Data loss/corruption, cross-tenant exposure, broken durable invariant, or unrecoverable critical data |
| P2 | Client-breaking schema/API compatibility, migration contract, or status/behavior drift |
| P3 | Unmeasured query/index/migration/retention/restore risk without proven P1/P2 impact |
